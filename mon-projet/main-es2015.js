...
InscriptionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: InscriptionComponent, selectors: [["app-inscription"]], inputs: { navigation: "navigation" }, decls: 56, vars: 1, consts: [[2, "width", "100%", "height", "100vh", "background-color", "rgba(68, 68, 68, 0.8)", "position", "absolute"], [1, "modal-dialog", "modal-lg", 2, "width", "80%"], [1, "modal-content"], [1, "modal-body"], ["type", "button", "aria-label", "Close", 1, "close", 3, "click"], ["aria-hidden", "true"], [2, "margin", "50px"], [3, "ngSubmit"], ["rf", "ngForm"], [1, "form-row"], [1, "form-group", "col-md-6"], ["for", "inputEmail4"], ["type", "email", "id", "inputEmailinscription2", "name", "email", "ngModel", "", "required", "", 1, "form-control"], ["for", "inputPassword4"], ["type", "password", "id", "inputPassword4", "name", "password", "ngModel", "", "required", "", 1, "form-control"], ["for", "nomid"], ["type", "text", "id", "nomid", "name", "nom", "ngModel", "", "required", "", 1, "form-control"], ["for", "prenomid"], ["type", "text", "id", "prenomid", "name", "prenom", "ngModel", "", "required", "", 1, "form-control"], [1, "form-group"], ["for", "inputAddress2"], ["type", "tel", "id", "inputAddress2", "placeholder", "numero de t\u00E9l\u00E9phone ", "name", "tel", "ngModel", "", "required", "", 1, "form-control"], ["for", "inputAddress"], ["type", "text", "id", "inputAddress", "placeholder", "1234 Main St", "name", "rue", "ngModel", "", "required", "", 1, "form-control"], ["for", "inputCity"], ["type", "text", "id", "inputCity", "name", "ville", "ngModel", "", "required", "", 1, "form-control"], [1, "form-group", "col-md-2"], ["for", "inputZip"], ["type", "number", "id", "inputZip", "name", "codepostale", "ngModel", "", "required", "", 1, "form-control"], [1, "form-check"], ["type", "checkbox", "id", "gridCheck", "name", "accepter", "ngModel", "", "required", "", 1, "form-check-input"], ["for", "gridCheck", 1, "form-check-label"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"]], template: function InscriptionComponent_Template(rf, ctx) { if (rf & 1) {
        const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
