...
function PostComponent_button_22__svg_svg_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
...
function PostComponent_button_22_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PostComponent_button_22_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.onMessage(); });
...
function PostComponent_div_25_div_4_Template(rf, ctx) { if (rf & 1) {
...
MapComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MapComponent, selectors: [["app-map"]], decls: 2, vars: 0, consts: [["id", "map"]], template: function MapComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
class connexionService {
    ...
    seConnecter(connexionInfo) {
        ...
        this.httpclient.post(this.base_url + '/connexion/', connexionInfo)
            .subscribe((stat) => { this.connecte = true; this.id_compte = stat.id; this.att = stat.att; this.long = stat.long; this.tocken = stat.tocken; this.route.navigate(['accueil-utilisateur']); this.wait = false; }, (err) => { alert('echec d\'autenfication'); this.wait = false; });
    }
    seDeconecter() {
        this.connecte = false;
        this.tocken = 'invalid';
